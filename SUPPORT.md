...
[`COMPATIBILITY.md`](COMPATIBILITY.md). The root and adapter modules have
stable v1 releases; unreleased main-branch changes remain subject to the
compatibility policy until published.
